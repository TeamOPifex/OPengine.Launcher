...
function convertHelperWindow(app, path, isProject) {

	console.log('Opening Convert window');

	var registeredShortcuts = [];
  	var currentWindow = global.windowCount++;

	var mainWindowState = WindowStateKeeper('convertHelper', {
	    width: 232,
	    height: 76
	});
...
export default convertHelperWindow;
