...
var Viewport = function ( editor ) {
    ...
    var t = event.dataTransfer.getData("type");
	...
	signals.rendererChanged.add( function ( newRenderer ) {
		...
		console.log('renderer changed', container.dom.offsetWidth, container.dom.offsetHeight);
	...
	signals.windowResize.add( function () {
		...
		//console.log('window resized', container.dom.offsetWidth, container.dom.offsetHeight);
